...
async function main(): Promise<void> {
  ...
  app.listen(config.port, () => {
    ...
    logger.info("Tools: getMyTickets, searchJira, getIssueDetails, createIssue, addComment, updateIssue, listProjects, editIssue, searchPages, getPage, listSpaces, createPage");
